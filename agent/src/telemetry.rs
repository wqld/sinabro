...
/// Fetch an opentelemetry::tace::TraceId as hex through the full tracing stack
pub fn get_trace_id() -> TraceId {
    // opentelemetry::Context to opentelemetry::trace::Span
    use opentelemetry::trace::TraceContextExt as _;
    // tracing::Span to opentelemetry::Context
